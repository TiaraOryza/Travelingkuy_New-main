...
import img2 from '../assets/img/beach/balangan.jpg';
import img3 from '../assets/img/beach/kuta.jpg'
import img4 from '../assets/img/beach/dreamlan.jpg'
...
const cardData = [
  {
    ...
    rating: "4.0",
    description: "Discover the stunning Kelingking Beach – where dramatic cliffs meet pristine sands and crystal-clear waters. A hidden paradise perfect for breathtaking views",
    location: "Nusa Penida Palace Bali",
    price: "$129",
    tooltips: ["Maximal 3 person", "View Detail", "1 car and driver", "Price include 1 Guide"],
    detailPage: "/DeskripsiKelingkingpage",
  },
  {
    imageUrl: img2,
    title: "Balangan Beach",
    rating: "4.8",
    description: "Relax on the serene shores of Balangan Beach – a tranquil retreat with golden sands and perfect waves. Enjoy a peaceful escape and stunning sunsets at Balangan Beach!",
    location: "Jimbaran Place Bali",
    price: "$100",
    tooltips: ["Maximal 3 person", "View Detail", "1 car and driver", "Price include 1 Guide"],
    detailPage: "/DeskripsiBalanganpage",
  },
  {
    imageUrl: img3,
    title: "Kuta",
    rating: "4.5",
    description: "Experience the vibrant energy of Kuta Beach – Bali's iconic stretch of sand known for its lively surf, bustling nightlife, and endless entertainment.",
    location: "Place Kuta Bali",
    price: "$129",
    tooltips: ["Maximal 3 person", "View Detail", "1 car and driver", "Price include 1 Guide"],
    detailPage: "/DeskripsiKutapage",
  },
  {
    imageUrl: img4,
    title: "Dreamland Beach",
    rating: "4.5",
    description: "Escape to Dreamland Beach – a stunning stretch of golden sand and turquoise waves, ideal for sunbathing and surfing. Discover your own slice",
    location: "Place Jimbaran Bali",
    price: "$110",
    tooltips: ["Maximal 3 person", "View Detail", "1 car and driver", "Price include 1 Guide"],
    detailPage: "/DeskripsiDreamlandpage",
  },
];
