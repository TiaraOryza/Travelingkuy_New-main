...
const DeskripsiDestinasiComponents = ({
  title,
  about,
  price,
  facilities,
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 -m-16 mb-10">
...
export default DeskripsiDestinasiComponents;
