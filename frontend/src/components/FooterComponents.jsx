    ...
    <footer className="relative w-full bg-gray-100 mt-36 font-poppins">
      <div className="mx-auto w-full max-w-7xl px-8 ">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          ...
          <Typography variant="h5" className="mb-6 mt-5 text-customBrown">
            Traveling Kuy
            <br />
            <span className='text-gray-600 font-poppins text-xs'>Serving you in the best traveling experience</span>
          </Typography>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-200 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center  text-customBrowntwo font-medium font-poppins md:mb-0"
          >
